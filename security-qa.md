...
- Production headers include CSP, HSTS, anti-framing, MIME sniffing protection,
  a restrictive permissions policy and strict referrer handling.
...
requests. Rate limits are intentionally per Google user because Vercel does not
proxy the authenticated Apps Script API calls.
